import Term from "@site/src/components/terms/TermPreview";

:::::terminology
::::term{title="JSON Web Token" #jwt .heliannuuthus .robot}
...
::::term{title="JSON Web Algorithms" #jwa .heliannuuthus .robot}
...
::::term{title="JSON Web Key" #jwk .heliannuuthus .robot}
...
::::term{title="JSON Web Signature" #jws .heliannuuthus .robot}
...
::::term{title="JSON Web Encryption" #jwe .heliannuuthus .robot}
